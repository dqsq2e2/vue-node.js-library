...
-- 5. 初始化数据库连接配置
-- ===========================
INSERT INTO `db_connections` (`db_name`, `db_type`, `host`, `port`, `database_name`, `username`, `password_enc`, `status`, `sync_priority`) VALUES
('mysql_main', 'mysql', '47.109.158.57', 3306, 'library_management', 'root', 'mysql_PX2NM5', '激活', 1),
('mariadb_backup', 'mariadb', '47.109.158.57', 3307, 'library_management', 'root', 'mysql_PX2NM5', '激活', 2),
('greatsql_archive', 'greatsql', '47.109.158.57', 3308, 'library_management', 'root', 'mysql_PX2NM5', '激活', 3);
